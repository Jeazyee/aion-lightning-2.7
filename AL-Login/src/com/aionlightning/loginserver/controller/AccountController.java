...
import com.aionlightning.loginserver.network.aion.LoginConnection.State;
import com.aionlightning.loginserver.network.aion.serverpackets.SM_SERVER_LIST;
import com.aionlightning.loginserver.network.aion.serverpackets.SM_UPDATE_SESSION;
...
public class AccountController {
	 ...
	 * If {@link com.aionlightning.loginserver.configs.Config#ACCOUNT_AUTO_CREATION} is enabled - creates new account.<br>
	 * 
	 * @param name
	 *          name of account
	 * @param password
	...
	public static AionAuthResponse login(String name, String password, LoginConnection connection)
	{
		...
		// Age Limit Check
		if(account.getAgeLimit() < Config.AGE_LIMIT_LEVEL && Config.AGE_LIMIT_ENABLE)
		{
	...
	/**
	 * Returns {@link com.aionlightning.loginserver.dao.AccountDAO}, just a shortcut
	 * 
	 * @return {@link com.aionlightning.loginserver.dao.AccountDAO}
	 */
	...
	/**
	 * Returns {@link com.aionlightning.loginserver.dao.AccountTimeDAO}, just a shortcut
	 * 
	 * @return {@link com.aionlightning.loginserver.dao.AccountTimeDAO}
	 */
